...
- 🌍 **World Map Game** – guess countries and see them highlighted on a live map.
  ![src/assets/readme/wordl_map.png](https://github.com/pranjallk1995/Fun-Games/blob/0120aeb3cbfbc841a160e72b17c6db4932c9cd05/src/assets/world_map.png)
...
Change line no. 22 in docker compose to False. (ollama server needed for typing game as text is generated by llama3 model and is supposed to be put in this network)
